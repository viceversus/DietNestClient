...
NSString * const kTesselGATTDeviceName = @"Tessel";
...
@interface CFTesselBluetoothManager () <CBCentralManagerDelegate, CBPeripheralDelegate>
...
@property (nonatomic) CFTesselBluetoothStatus status;
@end


@implementation CFTesselBluetoothManager
...
- (void)setStatus:(CFTesselBluetoothStatus)status {
    _status = status;
